...
% The sink monitors large variations within a
...
% (active and inactive, the latter being momentarily enabled only to receive the list) 
...
established.
% Although this solution considers the energy level of the nodes in the choice of the
...
As one can observe 
% in Fig. \ref{fig:num-msg-without-naive}
, the BCWSN-CH is
